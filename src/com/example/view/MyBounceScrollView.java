 ...
 * 
 */
public class MyBounceScrollView extends ScrollView {
    ...
    public MyBounceScrollView(Context context){  
        super(context);  
        mContext = context;  
        initBounceScrollView();  
    }  
       
    public MyBounceScrollView(Context context, AttributeSet attrs){  
        super(context, attrs);  
        mContext = context;  
        initBounceScrollView();  
    }  
       
    public MyBounceScrollView(Context context, AttributeSet attrs, int defStyle){  
	...
	public void commOnTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_UP:
			...
			int distanceY = (int) (inner.getTop() - normal.top);// 滑动距离
			//下拉一定距离，刷新
			if (isMoveing && distanceY>100){
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (isMoveing) {
				...
				int disInner = inner.getBottom() - normal.bottom;
				int disView= bottom - initbottom;
				int diffValue = disInner - disView;
				if (diffValue < 200) {
					top -= (deltaY / 6);
					bottom -= (deltaY / 6);
	...
	public void animation() {
		...
		TranslateAnimation taa = new TranslateAnimation(0, 0, top ,
				initTop);
		taa.setDuration(200);
